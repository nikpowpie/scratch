...
* @package    Scratch
* @author     Nikki Pierre
* @link       http://www.nikkipierre.com/
* @copyright  Copyright (c) 2016, Nikki Pierre
* @license    GPL-2.0+
*/
...
function scratch_setup() {
  ...
  define( 'CHILD_THEME_URL', 'http://github.com/nikpowpie/scratch' );
  ...
  // Add theme support for accessiblility.
